...
{
    public class ERFormsAuthenticationService
    {
        private IMembershipService _MembershipService;

        public ERFormsAuthenticationService(IMembershipService membershipService)
        {
        ...
        public AuthStatus SignIn(string userName, string password, bool createPersistentCookie)
        {
            ...
            {
                var commaSeparatedRolesBuilder = new StringBuilder();
                ...
                if (commaSeparatedRolesBuilder.Length > 0)
                    commaSeparatedRolesBuilder.Remove(commaSeparatedRolesBuilder.Length - 1, 1);
        ...
        private static FormsAuthenticationTicket CreateAuthenticationTicket(string userName, string commaSeparatedRoles,
        ...
        /// <param name="createPersistentCookie">True or false whether to create persistant cookie</param>
        /// <param name="strCookiePath">Path for which the authentication ticket is valid</param>
        private static void SetAuthCookieMain(string userName, string commaSeparatedRoles, bool createPersistentCookie,
                                              string strCookiePath)
        {
            FormsAuthenticationTicket ticket = CreateAuthenticationTicket(userName, commaSeparatedRoles,
